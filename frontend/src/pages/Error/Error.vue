  ...
  <div class="error-page">
    <b-container>
      <div class="errorContainer mx-auto">
        ...
        <p class="errorInfo">Oops, it seems this page does not exist.</p>
        ...
        <router-link class="mt-3 d-block" to="/">
          <button class="btn btn-default" type="button">To main page</button>
        </router-link>
      </div>
      <footer class="pageFooter">
        {{ new Date().getFullYear() }} &copy; Laravel Validation
      </footer>
    </b-container>
  </div>
</template>
