...
Route::group([
    ...
    Route::get('articles/autocomplete', [ArticlesController::class, 'findAllAutocomplete']);
    ...
    Route::get('comments/autocomplete', [CommentsController::class, 'findAllAutocomplete']);
